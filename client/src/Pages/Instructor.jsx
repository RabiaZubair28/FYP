...
const PersonalInfo = () => {
    ...
    const getDetails = async () => {
        try{
            const response = await fetch(`${import.meta.env.VITE_APP_API_URL}/api/data/instructor/${params.id}`,{
              method: "GET",
...
00 focus:border-blue-500"
  ...
  const ResearchInfo = () => {
    ...
    const getresearchPapers = async () => {
        try{
            const response = await fetch(`${import.meta.env.VITE_APP_API_URL}/api/data/research/${params.id}`,{
              method: "GET",
